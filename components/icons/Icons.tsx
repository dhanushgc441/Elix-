...
export const WebSearchIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM4.332 6.323l-1.082 3.603a6.002 6.002 0 0111.41-.125l-2.5-1.25a1 1 0 00-1.333.208 3.997 3.997 0 00-3.328-1.554 1 1 0 00-.917-.132L4.332 6.323zm1.603 7.28l1.18 1.18a4.002 4.002 0 004.475-1.12 1 1 0 00-.215-1.332l-1.25-2.5a6.002 6.002 0 01-4.065 3.527l-.125.245z" clipRule="evenodd" />
    </svg>
);
...
export const MicrophoneIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" {...props}>
        ...
        <path d="M5.5 13a.5.5 0 00-1 0v.5A4.5 4.5 0 009 18v1h-1.5a.5.5 0 000 1h5a.5.5 0 000-1H11v-1a4.5 4.5 0 004.5-4.5V13a.5.5 0 00-1 0v.5a3.5 3.5 0 01-7 0v-.5z" />
    </svg>
);

export const SpeakerOnIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
        <path d="M10 3a1 1 0 011 1v12a1 1 0 11-2 0V4a1 1 0 011-1zM5 7a1 1 0 011 1v4a1 1 0 11-2 0V8a1 1 0 011-1zm10 0a1 1 0 011 1v4a1 1 0 11-2 0V8a1 1 0 011-1z" />
    </svg>
);
...
export const VideoCameraIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" {...props}>
        ...
        <path d="M14.553 5.553A1 1 0 0116 6.447V13.553a1 1 0 01-1.447.894l-3-2A1 1 0 0111 11.553V8.447a1 1 0 01.553-.894l3-2z" />
    </svg>
);
